        ...
        for i in range(len(lines)):
            for j in range(len(lines[i])):
                ...
                if tl_2 > prev_tr and bl_2 > prev_line_br:
                    ...
                    letter_norm = resize(letter_raw ,(25, 100))
...
training_files = ['./ocr/signA.png', './ocr/signB.png']
...
for files in training_files:
	...
	for i in letters:
		...
		imsave('training_set/' + folder_string[name_counter] + '/' + folder_string[name_counter] + str(number) + '.png', i)
		number += 1
	name_counter += 1
